...
This tidy table set was generated from raw data in the skanit format
(see the raw file stored at
`system.file("extdata", "skanit.csv", package = "plate2N"))`. The data
wrangling pipeline followed steps of the vignette (see
