...
- [`add_spacers()`](https://mdetoeuf.github.io/plate2N/reference/add_spacers.md)
  : Interleave plots with spacer panels for visual gaps in patchwork
  layouts

- [`auto_to_tibble()`](https://mdetoeuf.github.io/plate2N/reference/auto_to_tibble.md)
  : Automatically detect and extract 96-well plate layouts from a raw
  data file
...
- [`plot_list_qc_microresp()`](https://mdetoeuf.github.io/plate2N/reference/plot_list_qc_microresp.md)
  : Build per-substrate/treatment QC plots for MicroResp data, paginated
  into panels
...
- [`plot_poly_significance()`](https://mdetoeuf.github.io/plate2N/reference/plot_poly_significance.md)
  : Plot the distribution of polynomial x² coefficient significance
  across curves
...
- [`tidy_plates`](https://mdetoeuf.github.io/plate2N/reference/tidy_plates.md)
