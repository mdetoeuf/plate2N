...
#>  [1] "Y" "B" "Z" "A" "N" "X" "T" "F" "V" "I" "U" "L" "E" "P" "J"
...
#> 2 A      Std   Y     Z     N     T     V     U     extr  E     J     empty Std  
#> 3 B      Std   Y     Z     N     T     V     U     extr  E     J     empty Std  
#> 4 C      Std   Y     Z     N     T     V     U     extr  E     J     empty Std  
#> 5 D      Std   Y     Z     N     T     V     U     extr  E     J     empty Std  
#> 6 E      Std   B     A     X     F     I     L     extr  P     empty empty Std  
#> 7 F      Std   B     A     X     F     I     L     extr  P     empty empty Std  
#> 8 G      Std   B     A     X     F     I     L     extr  P     empty empty Std  
#> 9 H      Std   B     A     X     F     I     L     extr  P     empty empty Std
```
